...
sed -i '.bak' -e "s/SERVICE_TASKCOUNT_MAX/$SERVICE_TASKCOUNT_MAX/g" $AWS_CONF_TARGET_DIR/*.json
sed -i '.bak' -e "s/SERVICE_TASKCOUNT_MIN/$SERVICE_TASKCOUNT_MIN/g" $AWS_CONF_TARGET_DIR/*.json
