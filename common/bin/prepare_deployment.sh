...
sed -i '.bak' -e "s/SERVICE_TASKCOUNT_MAX/$SERVICE_TASK_COUNT_MAX/g" $AWS_CONF_TARGET_DIR/*.json
sed -i '.bak' -e "s/SERVICE_TASKCOUNT_MIN/$SERVICE_TASK_COUNT_MIN/g" $AWS_CONF_TARGET_DIR/*.json
